...
class MailMessage(models.Model):
    ...
    def create(self, vals_list):
        ...
        for message in records:
            ...
            # Skip if we're already processing (using context, not class var)
            if self.env.context.get('skip_ai_processing'):
                continue
    ...
    def _post_ai_response(self, channel, ai_response):
        ...
        channel.with_context(skip_ai_processing=True).message_post(
            body=ai_response,
